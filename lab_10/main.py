...
FUNCTIONS = ['cos(x) * sin(z)', 'cos(x)', 'x + z', 'exp(sin(x^2 + y^2))']
...
class MainWindow(QMainWindow, lab_10_ui.Ui_MainWindow):
    def __init__(self):
        ...
        self.function = ''
        self.bordersX = [0, 0] #начало и конец
        self.bordersZ = [0, 0]
    ...
    def addToUI(self):
        ...
        #self.spinbox_rotateX.valueChanged.connect(self.draw3dSurface)
    ...
    def addChooseFunctions(self):
        ...
        self.box_functions.addItem(FUNCTIONS[3])
    ...
    def draw3dSurface(self):
        ...
        #self.timerId = self.startTimer(10000)
        #self.label_function.setText(str(self.spinbox_rotateX.value()))
        ...
        #self.label_6.setText(str(self.spinbox_rotateX.value()))

    def getData(self):
        self.function = self.box_functions.currentText()
        self.bordersX[0] = self.spinbox_start_x.value()
        self.bordersX[1] = self.spinbox_end_x.value()

        self.bordersZ[0] = self.spinbox_start_z.value()
        self.bordersZ[1] = self.spinbox_end_z.value()

        self.stepX = self.spinbox_step_x.value()
        self.stepZ = self.spinbox_step_z.value()
