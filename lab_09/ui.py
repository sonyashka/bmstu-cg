...
"Ctrl+Z - Отмена отсечения"))
    ...
    def task(self):
        ...
        taskMes.setText("Предоставить пользователю возможность ввода выпуклого отсекателя и отсекаемого многоугольника. Выделить отсеченные элементы другим цветом.")
    ...
    def info(self):
        ...
        infoMes.setText("Лабораторная работа №9 'Отсечение произвольного многоугольника выпуклым отсекателем' была написана Параскун Софией, ИУ7-44Б")
