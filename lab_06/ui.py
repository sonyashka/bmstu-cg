...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(800, 578))
        ...
        self.colorBox.setGeometry(QtCore.QRect(610, 120, 171, 22))
        ...
        self.labelColor.setGeometry(QtCore.QRect(610, 90, 171, 31))
        ...
        self.labelMethod.setGeometry(QtCore.QRect(610, 160, 171, 31))
        ...
        self.paintBox.setGeometry(QtCore.QRect(610, 190, 171, 22))
        ...
        self.paintBut.setGeometry(QtCore.QRect(650, 230, 93, 28))
        self.paintBut.setStyleSheet("background-color: rgb(255, 145, 135);")
        self.paintBut.setObjectName("paintBut")
        self.labelTitle = QtWidgets.QLabel(self.centralwidget)
        self.labelTitle.setGeometry(QtCore.QRect(610, 10, 171, 51))
        ...
        self.label.setGeometry(QtCore.QRect(610, 270, 171, 251))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Кнопочный фунцкионал:\n"
"Ctrl+S - Начало ввода точек фигуры\n"
"Ctrl+E - Конец ввода точек фигуры\n"
...
"Ctrl+P -Выбор затравочной точки\n"
"Ctrl+Z - Убрать заливку\n"
"Cltr+C - Очистить экран"))
    ...
    def info(self):
        ...
        infoMes.setText("Лабораторная работа №6 'Затравочные алгоритмы заполнения' была написана Параскун Софией, ИУ7-44Б")
