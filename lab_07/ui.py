...
"Ctrl+C - Очистить экран"))
    ...
    def task(self):
        ...
        taskMes.setText("Предоставить пользователю возможность ввода регулярного отсекателя и отсекаемых отрезков. Выделить отсеченные элементы другим цветом.")
    ...
    def info(self):
        ...
        infoMes.setText("Лабораторная работа №7 'Отсечение регулярным отсекателем' была написана Параскун Софией, ИУ7-44Б")
